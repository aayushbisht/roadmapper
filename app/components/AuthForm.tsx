  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-[#2a2a2a] rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-[#b0b0b0] bg-[#303030] hover:bg-[#404040] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
